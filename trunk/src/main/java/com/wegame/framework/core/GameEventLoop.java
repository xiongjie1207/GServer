    ...
    public void dispatch(IPacket packet, ISession session) {
        try {
            ...
            if (action != null) {
                ...
                log.warn("Not mapping found for socket protocol:"+packet.getModule()+"_"+ packet.getPid());
            }
        } catch (Exception e) {
    ...
    public void dispatch(IPacket packet, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (action != null) {
                ...
                log
                    .warn("Not mapping found for http protocol:"+packet.getModule()+"_"+ packet.getPid());
            }
        } catch (Exception e) {
            // TODO Auto-generated catch block
            log.error("exception", e);
